# -*- coding: utf-8 -*-
"""distilbert-lora-privacy.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1e2SEnOVOs9iVlh5lrbQ1D7P9fCQim7Hj
"""
...
lora_config = LoraConfig(
    r=8,  # Rank
    lora_alpha=32,
    target_modules=["q_lin", "v_lin"],  # attention modules to modify
    lora_dropout=0.1,
    bias="none",
...
plt.legend()
plt.tight_layout()
plt.savefig('dp_distilbert_epsilon.png')
plt.show()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('dp_training_distilbert_detailed_metrics.png')
plt.show()

torch.save(model.state_dict(), 'distilbert_lora_privacy.pt')